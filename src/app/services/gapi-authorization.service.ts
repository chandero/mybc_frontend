...
import { GoogleState } from '../store/reducer';
import { CLIENT_ID } from './constants';
import { GapiLoader } from './gapi-loader.service';

import {} from '@types/gapi';
import {} from '@types/gapi.auth2';
import {} from '@types/gapi.people';


@Injectable()
export class GoogleService {
  private _googleAuth: gapi.auth2.GoogleAuth;
  private _scope = 'profile email https://www.googleapis.com/auth/contacts.readonly';
  ...
  constructor(
    private zone: NgZone,
    private store: Store<GoogleState>,
